*********************************************************
* README.TXT: SourceMonitor - Version 3.5.0.306 - June 20, 2014
*********************************************************

Features Added to V3.5.0.306:

1) New CSV export separator option.
2) Decimal and thousands separators now based on Window country settings.
3) Added a user contribution: an Excel spreadsheet that summarizes
...
SourceMonitor is a Win32 program that that is supported on Window 7
and Windows 8. To install it, just run the SMSetupVnnnn.exe program
...
All bugs through number 225 have been fixed.
...
The following is a list of features that may appear a future upgrade:
