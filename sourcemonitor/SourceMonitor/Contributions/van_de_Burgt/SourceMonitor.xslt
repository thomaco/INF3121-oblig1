  ...
  <head>
    ...
    <style type="text/css">
      ...
      TH.HeaderCell
      {
        ...
        <title>
    <xsl:value-of select="/sourcemonitor_metrics/project/project_name"/> metrics (<xsl:value-of select="/sourcemonitor_metrics/project/project_directory"/>)
        </title>
  </head>
  <body>
    <div class="links" align="right" style="font-size: x-small">
      ...
      <a class="ExpandCollapseLink" href="SourceMonitor-details.xml">Details</a>
       |
      <a class="ExpandCollapseLink" href="javascript:ToggleDisplay('HideDetails');"><span name="HideDetails" style="display: ''">&#8226;</span>Toggle details</a>
       |
      <a class="ExpandCollapseLink" href="javascript:ToggleDisplay('ShowAllMethods');"><span name="ShowAllMethods" style="display: 'none'">&#8226;</span>Toggle all methods</a>
       |
      <a class="ExpandCollapseLink" href="javascript:ToggleDisplay('ShowOlderMetrics');"><span name="ShowOlderMetrics" style="display: 'none'">&#8226;</span>Toggle older metrics</a>
    </div>
    <h1>
      <xsl:value-of select="/sourcemonitor_metrics/project/project_name"/> metrics
    </h1>
    Project directory: <xsl:value-of select="/sourcemonitor_metrics/project/project_directory"/>
...
<xsl:template name="chkpnt">
  <h2><xsl:value-of select="./@checkpoint_date"/>:   <xsl:value-of select="./@checkpoint_name"/></h2>
  <table class="MeasurementsTable">
    <tr class="HeaderRow">
      ...
      <th class="HeaderCell"><xsl:value-of select="."/></th>
      </xsl:for-each>
    </tr>
    <xsl:choose>
...
<xsl:template match="file" name="summary">
  <tr class="DataRow">
    <td class="NameDataCell"><xsl:value-of select="@file_name"/></td>
  ...
  <tr class="DataRow">
    ...
    <xsl:variable name="ColumnTotal"><xsl:value-of select="count(/sourcemonitor_metrics/project/metric_names/metric_name)"/></xsl:variable>
...
<xsl:template match="method">
    <tr class="DataRow">
      <td class="NameDataCell" ><xsl:value-of select="@name"/></td>
      <td class="DataCell"><xsl:value-of select="complexity"/></td>
      <td class="DataCell"><xsl:value-of select="maximum_depth"/></td>
      <td class="DataCell"><xsl:value-of select="statements"/></td>
      <td class="DataCell"><xsl:value-of select="calls"/></td>
    </tr>
</xsl:template>
