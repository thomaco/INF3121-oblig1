...
\section{\textit{Requirement 1} - Description, analysis and test cases}
	...
	\subsection{Test cases - Functional testing}
	Here we use the black-box technique where we don´t see the internal
	structure of the program at all.
 ...
 %Start of test-cases
	...
	\end{enumerate}
	\textbf{Expected results:}One letter is revealed in the secret word.\newline
